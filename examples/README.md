...
| agent-debt-pr ([live demo branch](https://github.com/nonlooped/contextlevy/tree/examples/live-demo/examples/agent-debt-pr)) | `pnpm-lock.yaml`, `dist/app.js`, `.agents/skills/onboarding/SKILL.md` | lockfile, build output, agent config |
...
**[Live demo PR](https://github.com/nonlooped/contextlevy/pull/17)** — `examples/live-demo` → `main` (do not merge)
