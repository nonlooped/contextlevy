...
**Live demo:** [open example PR](https://github.com/nonlooped/contextlevy/pull/17) — ContextLevy commenting on intentional high-context fixtures ([details](examples/README.md)).
